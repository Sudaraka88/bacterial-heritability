...
######################################################################################################################################
# pos = readRDS("cd_pos_NC.rds") # The two positions after filtering
...
pos = readRDS("mic_pos_NC.rds") # The two positions after filtering
tempVCF = read.vcfR("snps_mic.vcf") # for MIC dataset
